...
struct CountryInlineView_Previews: PreviewProvider {
    static var previews: some View {
        CountryInlineView(country: countriesForPreviews[0], colorNumbers: true, colorTreshold: 0.01, colorGrayArea: 0.005, activeMetric: .constant(.confirmed), manager: DataManager())
    }
}

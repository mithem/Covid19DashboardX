...
struct ProvinceInlineView_Previews: PreviewProvider {
    static var previews: some View {
        ProvinceInlineView(province: MockData.countries[0].provinces.first!, colorNumbers: true, colorTreshold: 0.01, colorGrayArea: 0.005, activeMetric: .confirmed, manager: DataManager())
    }
}

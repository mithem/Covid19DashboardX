...
class ModelDecodableTests: XCTestCase {
    ...
    func testCountryMeasurement() {
        ...
        var result: CountryMeasurement?
        do {
            result = try decoder.decode(CountryMeasurement.self, from: input)
        } catch {
            print(error)
        }
    ...
    func testFullRespone() {
        ...
        var result: Response?
        do {
            result = try decoder.decode(Response.self, from: input)
        } catch {
            print(error)
        }

...
class Covid19DashboardXUITests: XCTestCase {
    ...
    func testSettingsRoundTrip() {
        ...
        tablesQuery/*@START_MENU_TOKEN@*/.buttons["Widget"]/*[[".cells[\"Widget\"].buttons[\"Widget\"]",".buttons[\"Widget\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
        tablesQuery/*@START_MENU_TOKEN@*/.buttons["Country"]/*[[".cells[\"Country\"].buttons[\"Country\"]",".buttons[\"Country\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
        tablesQuery2.cells["Afghanistan"].children(matching: .other).element(boundBy: 0).tap()
        app.navigationBars["Widget"].buttons["Settings"].tap()
